...
//      */
//     public MotionProfileRunner(TalonSRX talon, MotionProfile motionProfile, boolean reverse) {
//         _talon = talon;
...
//                         System.out.println(_talon.getActiveTrajectoryVelocity());
...
//             System.out.println(_status + " : " + _heading + " : " +_pos + " : " +_vel);
...
//             double positionRot = isReversed ? profile[i][0] * -1 : profile[i][0];
//             double velocityRPM = isReversed ? profile[i][1] * -1 : profile[i][1];

//             /* for each point, fill our structure and pass it to API */
//             point.position = positionRot * Constants.NATIVE_PER_ROTATION; //Convert Revolutions to Units
//             point.velocity = velocityRPM * Constants.NATIVE_PER_ROTATION / 600.0; //Convert RPM to Units/100ms
//             //point.velocity =isReversed ? point.velocity * -1 : point.velocity;
